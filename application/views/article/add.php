            ...
            <ul>
              ...
              <li>
                ...
                <select name="authors[]" multiple>
                  <option value="0"<?php echo !isset($results['authorsForArticleId']) ? " selected" : ""?>>(none)</option>
                  <?php foreach ( $results['users'] as $user ) { ?>
                  <option value="<?php echo $user->id?>"<?php if(isset($results['authorsForArticleId'])) echo array_key_exists($user->id, $results['authorsForArticleId'])  ? " selected" : ""?>><?php echo htmlspecialchars( $user->id ) . " " . htmlspecialchars($user->login)?></option>
                  <?php }?>
                </select>
              </li>
